...
#define LED_RGB 0x111   /* Assumes bit 0,1,2 of GPIO is connected to an RGB LED  */
 ...
 */
#define LED_I2S_RX_CHANNEL 1
#define LED_I2S_TX_CHANNEL 2
...
//	volatile int Delay;
	...
	XGpio_SetDataDirection(&Gpio, LED_I2S_RX_CHANNEL, ~LED_RGB);
	XGpio_SetDataDirection(&Gpio, LED_I2S_TX_CHANNEL, ~LED_RGB);
