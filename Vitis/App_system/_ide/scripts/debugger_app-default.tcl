...
fpga -file D:/AudioProcessing/Project/Repo/SimpleMixer/SW/Vitis/SimpleMixer_Platform/hw/design_1_wrapper_30_07.bit
targets -set -nocase -filter {name =~"APU*"}
loadhw -hw D:/AudioProcessing/Project/Repo/SimpleMixer/SW/Vitis/SimpleMixer_Platform/export/SimpleMixer_Platform/hw/design_1_wrapper_30_07.xsa -mem-ranges [list {0x40000000 0xbfffffff}] -regs
