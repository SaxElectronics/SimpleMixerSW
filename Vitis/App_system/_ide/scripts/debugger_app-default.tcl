...
fpga -file D:/AudioProcessing/Project/Repo/SimpleMixer/SW/Vitis/SimpleMixer_Platform/hw/design_1_wrapper_I2S_FIFO128.bit
targets -set -nocase -filter {name =~"APU*"}
loadhw -hw D:/AudioProcessing/Project/Repo/SimpleMixer/SW/Vitis/SimpleMixer_Platform/export/SimpleMixer_Platform/hw/design_1_wrapper_I2S_FIFO128.xsa -mem-ranges [list {0x40000000 0xbfffffff}] -regs
