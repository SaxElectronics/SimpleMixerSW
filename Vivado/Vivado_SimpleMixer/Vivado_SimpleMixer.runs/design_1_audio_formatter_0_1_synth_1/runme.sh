...
HD_PWD='D:/AudioProcessing/Project/Repo/SimpleMixer/SW/Vivado/Vivado_SimpleMixer/Vivado_SimpleMixer.runs/design_1_audio_formatter_0_1_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_1_audio_formatter_0_1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_1_audio_formatter_0_1.tcl
