...
HD_PWD='D:/AudioProcessing/Project/Repo/SimpleMixer/SW/Vivado/Vivado_SimpleMixer/Vivado_SimpleMixer.runs/design_1_rst_clk_wiz_0_49M_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_1_rst_clk_wiz_0_49M_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_1_rst_clk_wiz_0_49M_0.tcl
